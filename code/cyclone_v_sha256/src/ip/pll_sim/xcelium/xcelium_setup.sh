...
# ACDS 22.1 922 linux 2023.11.27.15:04:09
...
TOP_LEVEL_NAME="pll"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/markus/build/quartus/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll.vho"
fi
